...
<head>
  ...
  <title> Contact Us | E-boook.com | {{ $data['subject'] }}</title>
  <style type="text/css">
        body {
          ...
          <td class='movableContentContainer' align="center">
            ...
            <div class='movableContent'>
              <table width="580" border="0" cellspacing="0" cellpadding="0" align="center">
                        ...
                        <td width='60'>
                          <div class='contentEditableContainer contentImageEditable'>
                            <div class='contentEditable'>
                              <a target='_blank' href="[CLIENTS.WEBSITE]"><img src="{{ asset('images/logo.png') }}" alt="Logo" width='60' height='60' data-default="placeholder" data-max-width="200"></a>
                            </div>
                          </div>
                        </td>
                        <td width='10'></td>
                        <td valign="middle" style='vertical-align: middle;'>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: left;font-weight: light; color:#555555;font-size:26;line-height: 39px;font-family: Helvetica Neue;'>
                              <h1 class='big'><a target='_blank' href="{{ app_path() }}" style='color:#444444'>E-Boook.com</a></h1>
                            </div>
                          </div>
                        </td>
                        <td width='10'></td>
                ...
                <tr><td height='15'></td></tr>
                <tr><td ><hr style='height:1px;background:#DDDDDD;border:none;'></td></tr>
              </table>
            </div>
              ...
              <table width="580" border="0" cellspacing="0" cellpadding="0" align="center">
                ...
                <tr>
                  <td width='150'>
                    <div class='contentEditableContainer contentImageEditable'>
                      <div class='contentEditable'>
                        <img src="images/side3.png" alt="side image" width='142' height='142' data-default="placeholder" data-max-width="150">
                      </div>
                    </div>
                  </td>
                  <td width='20'></td>
                      ...
                      <tr>
                        <td width='40'>
                          <div class='contentEditableContainer contentFacebookEditable'>
                            <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                              <img src="{{ asset('images/facebook.png') }}" alt="facebook" width='40' height='40' data-max-width="40" data-customIcon="true" >
                            </div>
                          </div>
                        </td>
                        <td width='10'></td>
                        <td width='40'>
                          <div class='contentEditableContainer contentTwitterEditable'>
                            <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                              <img src="{{ asset('images/twitter.png') }}" alt="twitter" width='40' height='40' data-max-width="40" data-customIcon="true">
                            </div>
                          </div>
                        </td>
                        <td width='10'></td>
                        <td width='40'>
                          <div class='contentEditableContainer contentImageEditable'>
                            <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                              <img src="{{ asset('images/youtube.png') }}" alt="Pinterest" width='40' height='40' data-max-width="40">
                            </div>
                          </div>
                        </td>
                        <td width='10'></td>
                        <td width='40'>
                          <div class='contentEditableContainer contentImageEditable'>
                            <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                              <img src="images/instagram.png" alt="Social media" width='40' height='40' data-max-width="40">
                            </div>
                          </div>
                        </td>
                      </tr>
