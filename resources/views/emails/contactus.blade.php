                    ...
                    <table width="480" border="0" cellspacing="0" cellpadding="0" align="center">
                      ...
                      <tr>
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              <h2 style="font-size: 20px;">{{ trans('general.contact_us') }}</h2>
                              <br>
                              <p>{{ $data['content'] }}.</p>
                    ...
                    <table width='190' cellpadding="0" cellspacing="0" align="center">
                      <tr>
                        ...
                        <td width='40'>
                          <div class='contentEditableContainer contentImageEditable'>
                            <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                              <img src="{{ asset('images/red.png') }}" alt="Pinterest" width='40' height='40' data-max-width="40">
                            </div>
                          </div>
                        </td>
                        <td width='10'></td>
                        <td width='40'>
                          <div class='contentEditableContainer contentImageEditable'>
                            <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                              <img src="images/blue.png" alt="Social media" width='40' height='40' data-max-width="40">
                            </div>
                          </div>
                        </td>
                      </tr>
