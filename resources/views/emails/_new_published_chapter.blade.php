...
<head>
    ...
    <title>  {{ trans('general.newsletter') }} | {{ trans('general.ebook') }} | {{ $data['book_title'] }}
        <br>
        {{ trans('general.chapter') }} : {{ $data['chapter_title'] }}
    </title>
    <style type="text/css">
        body {
                                                            ...
                                                            <td>
                                                                <div class='contentEditableContainer contentTextEditable'>
                                                                    <div class='contentEditable'
                                                                        ...
                                                                        <h2 style="font-size: 20px;"> New Published Chapter </h2>
                                                                        <h3>Title : {{ $data['chapter_title'] }}</h3>
                                                                        <br>
                                                                        <hr/>
                                                                        <p>
                                                                            <a href="http://eboook.com/frontend/book/.{{$data['book_id']}}">View the book</a>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
